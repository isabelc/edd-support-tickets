<?php
/**
 * EDDSTIX_Editor_Ajax Class
 *
 * Loads an instance of TinyMCE via Ajax call. Used to Reply to ticket on back end.
...
class EDDSTIX_Editor_Ajax {
	...
	public function editor_html() {
		...
		if ( empty( $editor_id ) ) {
			...
			// display a debugging notice
			echo '<pre>' . __( 'An editor ID is mandatory to load a new instance of TinyMCE', 'edd-support-tickets' ) . '</pre>';
	...
	public function get_quicktags_settings( $qtInit, $editor_id ) {
		$this->qt_settings = apply_filters( 'eddstix_ajax_editor_quicktags_settings', $qtInit );
		return apply_filters( 'eddstix_ajax_editor_quicktags_settings', $qtInit );
	}
	...
	public function get_tinymce_settings( $mceInit, $editor_id ) {
		$this->mce_settings = apply_filters( 'eddstix_ajax_editor_tinymce_settings', $mceInit );
		return apply_filters( 'eddstix_ajax_editor_tinymce_settings', $mceInit );
	}
